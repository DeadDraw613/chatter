...
test('user can register and send a connection request', async ({ page }) => {
  ...
  console.warn(`✅ STATUS: User ${username} registered`);
  ...
  console.warn(`✅ STATUS: Connection created`);
  ...
  console.warn(`✅ STATUS: Connection requested`);
